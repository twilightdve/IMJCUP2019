...
class Index {
  ...
  initialize() {
    window.onload = () => {
      ...
      velocity_animate__WEBPACK_IMPORTED_MODULE_1___default()(this.$kvAnniversary, {
        opacity: [1, 0],
        translateY: [0, 50]
        // rotateY: [0, '360deg']
      }, {
        ...
        display: 'block',
        complete: () => {
          velocity_animate__WEBPACK_IMPORTED_MODULE_1___default()(this.$kvTitle, {
            opacity: [1, 0],
            rotateY: [0, '90deg']
          }, {
            duration: 800,
            ...
            display: 'block',
            complete: () => {
              velocity_animate__WEBPACK_IMPORTED_MODULE_1___default()(this.$kvDate, {
                opacity: [1, 0]
              }, {
                duration: 300,
                easing: 'easeOutCubic',
                display: 'block',
                complete: () => {
                  velocity_animate__WEBPACK_IMPORTED_MODULE_1___default()([this.$kvScroll, this.$pcText], {
                    opacity: [1, 0]
                  }, {
                    duration: 500,
                    delay: 500,
                    ...
                    display: 'block',
                    complete: () => {
                      velocity_animate__WEBPACK_IMPORTED_MODULE_1___default()(this.$kvScroll, {
                        translateY: [15, 0]
                      }, {
                        duration: 700,
    ...
    const hammerTopButton = new hammerjs__WEBPACK_IMPORTED_MODULE_2___default.a(this.$menuTopButton);
    hammerTopButton.on('tap', e => {
      e.preventDefault();
      this.toggleMenu();
    });
    for (let i = 0; i < this.$teamItems.length; ++i) {
      const teamItem = new hammerjs__WEBPACK_IMPORTED_MODULE_2___default.a(this.$teamItems[i]);
      teamItem.on('tap', e => {
        e.preventDefault();
    ...
    const hammerModalOverlay = new hammerjs__WEBPACK_IMPORTED_MODULE_2___default.a(this.$modalOverlay);
  ...
  toggleMenu() {
    if (!this.isOpen) {
      velocity_animate__WEBPACK_IMPORTED_MODULE_1___default()(this.$menu, 'slideDown', {
        duration: 300,
        easing: 'easeOutCubic',
        display: 'block'
      });
      velocity_animate__WEBPACK_IMPORTED_MODULE_1___default()(this.$overlay, {
        opacity: 1
      }, {
        duration: 300,
        easing: 'easeOutCubic',
